...
def exportToFoam(mesh,dirname='polyMesh'):
    ...
    # print('Line 155: total number of faces: %d, internal: %d, external %d\n'  \
    ...
    # print('total number of faces: %d, internal: %d, external %d\n'  \
        # %(nrFaces,nrIntFaces,nrExtFaces),2)
...
def main():
    ...
    mesh = Mesh_1
    mName=mesh.GetName()
    outdir = r"C:\Users\aspen\openprop\meshing"
